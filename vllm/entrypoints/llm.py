...
from typing import Any, ClassVar, Dict, List, Optional, Sequence, Union, cast, overload
...
class LLM:
    ...
    def generate(
        self,
        prompts: Union[
            Union[PromptInputs, Sequence[PromptInputs]], Optional[Union[str, List[str]]]
        ] = None,
        sampling_params: Optional[
            Union[SamplingParams, Sequence[SamplingParams]]
        ] = None,
    ...
    def chat(
        ...
        conversation, mm_data = parse_chat_messages(messages, model_config, tokenizer)
